...
> If you want to see every single step how this E-commerce application is build and learn how to build your own Full Stack applications, check my website [personal-portfolio-bwb.pages.dev](https://personal-portfolio-bwb.pages.dev)
